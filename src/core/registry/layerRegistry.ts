...
const registryEntries: LayerTypeDef[] = [
  ...
  },
  {
    ...
    category: "residual",
    accent: "#b91c1c",
    description: "The 2-layer residual block used in ResNet-18/34.",
    inputs: [{ name: "in", tensorRank: 4 }],
    outputs: [{ name: "out", tensorRank: 4 }],
    params: [
      { name: "in_channels", label: "In Channels", type: "number", default: 64, required: true, min: 1 },
  ...
  },
  {
    ...
    label: "ResNetBottleneck",
    category: "residual",
    accent: "#991b1b",
    description: "The 3-layer bottleneck block used in ResNet-50/101.",
    inputs: [{ name: "in", tensorRank: 4 }],
    outputs: [{ name: "out", tensorRank: 4 }],
    params: [
      { name: "in_channels", label: "In Channels", type: "number", default: 256, required: true, min: 1 },
      { name: "bottleneck_channels", label: "Bottleneck", type: "number", default: 64, required: true, min: 1 },
      { name: "out_channels", label: "Out Channels", type: "number", default: 256, required: true, min: 1 },
      { name: "stride", label: "Stride", type: "number", default: 1, required: true, min: 1 },
      { name: "use_projection", label: "Projection", type: "boolean", default: false },
    ],
  },
  {
    ...
    category: "norm",
    accent: "#f59e0b",
    description: "Channel-wise normalization for 4D tensors (N,C,H,W).",
    inputs: [{ name: "in", tensorRank: 4 }],
    outputs: [{ name: "out", tensorRank: 4 }],
  ...
  },
  {
    ...
    category: "norm",
    accent: "#eab308",
    description: "Feature-wise normalization for 2D/3D tensors.",
    inputs: [{ name: "in" }],
    outputs: [{ name: "out" }],
    params: [{ name: "num_features", label: "Features", type: "number", default: 32, required: true, min: 1 }],
  },
  ...
  },
  {
    ...
    category: "attention",
    accent: "#5b21b6",
    description: "Single self-attention layer over a token sequence.",
    inputs: [{ name: "in", tensorRank: 3 }],
    outputs: [{ name: "out", tensorRank: 3 }],
    params: [
      { name: "embed_dim", label: "Embed Dim", type: "number", default: 512, required: true, min: 1 },
      { name: "num_heads", label: "Heads", type: "number", default: 8, required: true, min: 1 },
      { name: "batch_first", label: "Batch First", type: "boolean", default: true },
    ],
  },
  {
